...
namespace workIT.Utilities
{
	...
	public class EmailManager 
	{
		...
		{
			string toEmail = UtilityManager.GetAppKeyValue( "contactUsMailTo", "cwd.mparsons@siu.edu" );
			string fromEmail = UtilityManager.GetAppKeyValue( "contactUsMailFrom", "cwd-mparsons@siu.edu" );
	...
	//+ "\r\nError message: " + exc.ToString() );
		...
		public static bool SendEmail( string toEmail, string fromEmail, string subject, string message, string CC, string BCC )
		{
			...
			delim[ 0 ] = ',';
            MailMessage email = new MailMessage();
            string appEmail = UtilityManager.GetAppKeyValue( "contactUsMailFrom", "cwd-mparsons@siu.edu" );
			string systemAdminEmail = UtilityManager.GetAppKeyValue( "systemAdminEmail", "cwd-mparsons@siu.edu" );
